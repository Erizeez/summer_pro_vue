            ...
            <el-row class="el-row-2">
                <div class="info_box">
                    ...
                    <el-row :gutter="50" style="padding-left: 50px; margin-top: 20px; overflow: hidden;position: relative;">
                        ...
                        <el-col style="width: 18%; margin: 0px 0px 20px 0px;left:0px;" :span="5" v-if="brouseMode==false" v-for="(item,index) in doclist" :key="item.id">
                                ...
                                <div style="padding: 14px;">
                                    ...
                                    <div class="bottom clearfix">
                                        <div v-if="!isDelete" style="">
                                            <el-button size="small" type="primary" style="float: left;  margin-bottom: 5%;" round plain class="button" @click="todoc(item.id)">查看文档
                                            </el-button>
