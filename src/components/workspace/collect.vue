            ...
            <el-row class="el-row-2">
                <div class="info_box">
                    ...
                    <el-row :gutter="50" style="padding-left: 50px; margin-top: 20px; overflow: hidden;position: relative;">
                        ...
                        <el-col :span="24" style="width: 95%; margin: 0px 0px 20px 0px;">
                        <div style="overflow: hidden;" v-for="(item,i) in collectlist" :key="i" v-if="brouseMode==true" class="author-title">
                            <el-row :gutter="20">
                            <el-col :span="4">
                                <div>
                        ...
                        <el-col style="width: 18%; margin: -50px 0px 50px 0px;left:0px;" :span="5" v-if="brouseMode==false" v-for="(item,index) in collectlist" :key="item.id">
  ...
  export default {
    ...
    methods: {
      getcollectdoc() {
        ...
        this.$http.get('/doc/collectlist?accountId=' + userId).then(res => {
          console.log('hhh');
          console.log(res);
          if (res.status !== 200) {
