          ...
          <el-row :gutter="12" style="margin-top: 30px; margin-left: 30px">
            ...
            <el-col :span="4" v-for="item in TeamAdmin" :key="item.id">
              <el-card shadow="hover" >
                ...
                <el-button type="danger" icon="el-icon-delete" circle size="mini" v-if="onlyCreator" @click="kick(item)"></el-button>
              </el-card>
            </el-col>
          </el-row>
          ...
          <el-row :gutter="12" style="margin-top: 30px; margin-left: 30px" >
            <el-col :span="4" v-for="item in TeamCommon" :key="item.id">
              <el-card shadow="hover" >
                ...
                <div style="text-align: center; margin-top: 5px">{{item.name}}</div>
                <el-button @click="editMember(item)" type="primary" icon="el-icon-edit" circle style="margin-left: 15%; margin-top: 20px" size="mini"  v-if="onlyCreator || Admin"></el-button>
                <el-button type="danger" icon="el-icon-delete" circle size="mini"  v-if="onlyCreator || Admin" @click="kick(item)"></el-button>
              </el-card>
            </el-col>
          </el-row>
        </el-card>
          ...
          <el-form :model="thisMember">
            ...
            <el-form-item label="权限设置: " style="margin-left: 10%;margin-top: 30px">
              ...
              <el-checkbox-group v-model="rights.select">
                <el-checkbox v-for="(item,index) in rights.type" :key="index" :label="item.name" @click="addAuthority(index)"></el-checkbox>
              ...
              <el-button type="primary" @click="comfirmAuth">确认</el-button>
            </el-form-item>
      ...
      methods:{
        ...
        comfirmAuth(){
          ...
          for(var i=0,len=this.rights.select.length;i<len;i++){
            ...
            else if(this.rights.select[i]=="可评论"){
              this.authority+=4;
            }
            else{
              this.authority+=8;
